...
public class CsStrikes extends CsTemplate<Strike> {
    ...
    protected ContentValues toContentValues(Strike item) {
        ...
        contentValues.put(HgContract.Strikes.DATE_FROM, df.format(item.startDate));
        contentValues.put(HgContract.Strikes.DATE_TO, df.format(item.endDate));
        contentValues.put(HgContract.Strikes.ALL_DAY, item.allDay);
        ...
        contentValues.put(HgContract.Strikes.SOURCE_LINK, item.sourceLink);
